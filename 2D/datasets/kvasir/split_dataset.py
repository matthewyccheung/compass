...
base_path='/scratch/yc130/Kvasir-SEG/'
img_path=f'{base_path}images/'
seg_path=f'{base_path}masks/'
...
tr_files=files[:int(0.6*len(files))]
va_files=files[int(0.6*len(files)):int(0.8*len(files))]
ts_files=files[int(0.8*len(files)):]
